...
public class HomeFragment extends Fragment {
     private Button req_button ;
      Button b_vacantes_deta1;
   Button b_vacantes_deta2;
     Button b_vacantes_deta3;
 Button b_vacantes_deta4;
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        req_button.setOnClickListener(new View.OnClickListener() {
           ...
           startActivity(new Intent(getActivity(),Requisitos_Convocatorias.class));
            }
        });
